const getNestedObject = function (obj, dotSeparatedKeys) {
...
const buildSchema = function (schemaObject) {
...
const getSchemaMatch = function (obj, objFromSchema) {
    let result = false;
...
const convertSchemaAndGetMatch = function (obj, schemaObject) {
